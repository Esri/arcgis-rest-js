...
TEMP_FOLDER=esri-rest-js-v$VERSION;
...
git push https://github.com/ArcGIS/rest-js.git master
git push --tags
...
gh-release --t v$VERSION --repo rest-js --owner patrickarlt -a $TEMP_FOLDER.zip
