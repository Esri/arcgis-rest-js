...
var Reporter = /** @class */ (function () {
    function Reporter(config, threshold) {
        ...
        this.create = function (baseReporterDecorator, logger) {
            ...
            this.onRunComplete = function (collection, results) { return __awaiter(_this, void 0, void 0, function () {
                var browsers, coverageChecks, isCoverageCheckFailed;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            browsers = [];
                            collection.forEach(function (browser) { return browsers.push(browser); });
                            coverageChecks = browsers.map(function (browser) { return __awaiter(_this, void 0, void 0, function () {
                                    ...
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            Object.keys(config.reports).forEach(function (reportType) {
                                                ...
                                                var istanbulReportOptions = {
                                                    coverageMap: remappedCoverageMap,
                                                    dir: directory,
                                                    sourceFinder: sourceMapStore.sourceFinder,
                                                    watermarks: config.coverageOptions.watermarks
                                                };
                                                var context = istanbulReport.createContext(istanbulReportOptions);
                                                istanbulReports
                            ...
                            return [4 /*yield*/, Promise.all(coverageChecks)];
                        case 1:
                            isCoverageCheckFailed = (_a.sent())
                                .some(function (isCheckFailed) { return isCheckFailed; });
    ...
    Reporter.prototype.getReportDestination = function (browser, reportConfig, reportType) {
        ...
        if (lodash.isPlainObject(reportConfig)) {
            var subdirectory = (_a = reportConfig.subdirectory) !== null && _a !== void 0 ? _a : browser.name;
            if (typeof subdirectory === "function") {
                subdirectory = subdirectory(browser);
            }
            return path.join((_b = reportConfig.directory) !== null && _b !== void 0 ? _b : "coverage", subdirectory);
        }
