...
var Resolver = /** @class */ (function () {
    ...
    Resolver.prototype.resolveFilename = function (requiringModule, bundleItem, onFilenameResolved) {
        ...
        browserResolve(moduleName, bopts, function (error, filename) {
            ...
            if (bundleItem.filename && !bundleItem.isTypingsFile() && (bundleItem.filename.endsWith(".js") ||
            ...
            if (bundleItem.isNpmModule() && bundleItem.isTypingsFile()) {
                ...
                if (bundleItem.filename.indexOf(bundleItem.moduleName) === -1) {
                    var filepath = PathTool.fixWindowsPath(bundleItem.filename);
                    var matches = filepath.match(/\/node_modules\/(.*)\//);
                    if (matches && matches[1]) {
                        moduleName = matches[1];
                        _this.log.debug("Resolved module name [%s] to [%s]", bundleItem.moduleName, moduleName);
                    }
                }
