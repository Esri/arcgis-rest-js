...
exports.request = exports.internalRequest = exports.checkForErrors = exports.ArcGISAuthError = exports.getDefaultRequestOptions = exports.setDefaultRequestOptions = exports.NODEJS_DEFAULT_REFERER_HEADER = void 0;
const encode_form_data_js_1 = require("./utils/encode-form-data.js");
const encode_query_string_js_1 = require("./utils/encode-query-string.js");
const process_params_js_1 = require("./utils/process-params.js");
const ArcGISRequestError_js_1 = require("./utils/ArcGISRequestError.js");
const warn_js_1 = require("./utils/warn.js");
const arcgis_rest_fetch_1 = require("@esri/arcgis-rest-fetch");
...
function setDefaultRequestOptions(options, hideWarnings) {
    if (options.authentication && !hideWarnings) {
        (0, warn_js_1.warn)("You should not set `authentication` as a default in a shared environment such as a web server which will process multiple users requests. You can call `setDefaultRequestOptions` with `true` as a second argument to disable this warning.");
    }
...
function checkForErrors(response, url, params, options, originalAuthError) {
    ...
    if (response.code >= 400) {
        ...
        throw new ArcGISRequestError_js_1.ArcGISRequestError(message, code, response, url, options);
    }
    ...
    if (response.error) {
        ...
        throw new ArcGISRequestError_js_1.ArcGISRequestError(message, errorCode, response, url, options);
    }
...
function internalRequest(url, requestOptions) {
    ...
    if (typeof options.authentication === "string") {
        ...
        if (!options.authentication.startsWith("AAPK") && // doesn't look like an API Key
            ...
            (0, warn_js_1.warn)(`Using an oAuth 2.0 access token directly in the token option is discouraged. Consider using ArcGISIdentityManager or Application session. See https://esriurl.com/arcgis-rest-js-direct-token-warning for more information.`);
    ...
    return (authentication
        ...
        if (fetchOptions.method === "GET") {
            ...
            const queryParams = (0, encode_query_string_js_1.encodeQueryString)(params);
            // dont append a '?' unless parameters are actually present
            const urlWithQueryString = queryParams === "" ? url : url + "?" + (0, encode_query_string_js_1.encodeQueryString)(params);
            if (
    ...
    https://developers.arcgis.com/rest/users-groups-and-items/update-resources.htm
        ...
        if (fetchOptions.method === "POST") {
            fetchOptions.body = (0, encode_form_data_js_1.encodeFormData)(params, forceFormData);
        }
        ...
        if (!(0, process_params_js_1.requiresFormData)(params) && !forceFormData) {
        ...
        return globalThis.fetch
            ...
            : (0, arcgis_rest_fetch_1.getFetch)().then(({ fetch }) => {
