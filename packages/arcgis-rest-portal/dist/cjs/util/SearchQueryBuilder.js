...
class SearchQueryBuilder {
    ...
    endGroup() {
        if (this.openGroups <= 0) {
            (0, arcgis_rest_request_1.warn)(`\`endGroup(...)\` was called without calling \`startGroup(...)\` first. Your query was not modified.`);
            return this;
        }
        this.commit();
        this.openGroups--;
    ...
    addModifier(modifier) {
        ...
        if (this.q === "" && modifier !== "not") {
            (0, arcgis_rest_request_1.warn)(`You have called \`${modifier}()\` without calling another method to modify your query first. Try calling \`match()\` first.`);
            return this;
        }
    ...
    cleanup() {
        ...
        if (oldQ !== this.q) {
            (0, arcgis_rest_request_1.warn)(`\`startGroup(...)\` was called without calling \`endGroup(...)\` first. Your query was not modified.`);
        }
        // clear empty groups
