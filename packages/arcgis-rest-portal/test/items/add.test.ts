...
describe("search", () => {
  ...
  describe("Authenticated methods", () => {
    ...
    test("should add data to an item", async () => {
    ...
    test("should add data to an item, no owner passed", async () => {
      fetchMock.once("*", ItemSuccessResponse);
      const fakeData = {
        values: {
          key: "someValue"
    ...
    test("should add data to an item, extra parameters", async () => {
      fetchMock.once("*", ItemSuccessResponse);
      const fakeData = {
        values: {
          key: "someValue"
    ...
    test("should add binary item data by id", async () => {
      fetchMock.once("*", {
        success: true
      });
    ...
    test("should add a relationship to an item", async () => {
      fetchMock.once("*", { success: true });

      await addItemRelationship({
        originItemId: "3ef",
    ...
    test("should add a binary resource to an item", async () => {
      fetchMock.once("*", {
        success: true
      });
    ...
    test("should add a binary resource to a secret item", async () => {
      fetchMock.once("*", {
        success: true
      });
    ...
    test("should add a text resource", async () => {
      fetchMock.once("*", {
        success: true
      });
