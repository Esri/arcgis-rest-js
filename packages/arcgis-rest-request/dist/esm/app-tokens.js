 ...
 * @param portal
 */
export function exchangeToken(token, clientId, portal = "https://www.arcgis.com/sharing/rest") {
 ...
 * @param portal
 */
export function platformSelf(clientId, redirectUri, portal = "https://www.arcgis.com/sharing/rest") {
