/* @preserve
* @esri/arcgis-rest-request - v4.1.1 - Apache-2.0
* Copyright (c) 2017-2022 Esri, Inc.
* Tue Dec 27 2022 09:24:35 GMT-0800 (Pacific Standard Time)
*/
(function (global, factory) {
  ...
  })(exports.JOB_STATUSES || (exports.JOB_STATUSES = {}));
  ...
  class Job {
      constructor(options) {
          ...
          this.executePoll = async () => {
              ...
              try {
                  ...
                  this.emitter.emit(exports.JOB_STATUSES.Error, error);
                  return;
              }
              this.emitter.emit(exports.JOB_STATUSES.Status, result);
          ...
          return request(this.jobUrl, {
              ...
              switch (rawJobInfo.jobStatus) {
                  case "esriJobCancelled":
                      info.status = exports.JOB_STATUSES.Cancelled;
                      break;
                  case "esriJobCancelling":
                      info.status = exports.JOB_STATUSES.Cancelling;
                      break;
                  case "esriJobNew":
                      info.status = exports.JOB_STATUSES.New;
                      break;
                  case "esriJobWaiting":
                      info.status = exports.JOB_STATUSES.Waiting;
                      break;
                  case "esriJobExecuting":
                      info.status = exports.JOB_STATUSES.Executing;
                      break;
                  case "esriJobSubmitted":
                      info.status = exports.JOB_STATUSES.Submitted;
                      break;
                  case "esriJobTimedOut":
                      info.status = exports.JOB_STATUSES.TimedOut;
                      break;
                  case "esriJobFailed":
                      info.status = exports.JOB_STATUSES.Failed;
                      break;
                  case "expectedFailure":
                      info.status = exports.JOB_STATUSES.Failure;
                      break;
                  case "esriJobSucceeded":
                      info.status = exports.JOB_STATUSES.Success;
                      break;
              }
              return info;
          });
      ...
      async waitForCompletion() {
          ...
          if (jobInfo.status === exports.JOB_STATUSES.Success) {
              return Promise.resolve(jobInfo);
          }
          //if jobStatus comes back immediately with one of the statuses
          if (jobInfo.status === exports.JOB_STATUSES.Cancelling ||
              jobInfo.status === exports.JOB_STATUSES.Cancelled ||
              jobInfo.status === exports.JOB_STATUSES.Failed ||
              jobInfo.status === exports.JOB_STATUSES.Failure ||
              jobInfo.status === exports.JOB_STATUSES.TimedOut) {
          ...
          return new Promise((resolve, reject) => {
              ...
              this.once(exports.JOB_STATUSES.Cancelled, (jobInfo) => {
                  this.stopInternalEventMonitoring();
                  reject(new ArcGISJobError("Job cancelled.", jobInfo));
              });
              this.once(exports.JOB_STATUSES.TimedOut, (jobInfo) => {
                  this.stopInternalEventMonitoring();
                  reject(new ArcGISJobError("Job timed out.", jobInfo));
              });
              this.once(exports.JOB_STATUSES.Failed, (jobInfo) => {
                  this.stopInternalEventMonitoring();
                  reject(new ArcGISJobError("Job failed.", jobInfo));
              });
              this.once(exports.JOB_STATUSES.Success, (jobInfo) => {
                  this.stopInternalEventMonitoring();
                  resolve(jobInfo);
              });
          });
  ...
  exports.ArcGISJobError = ArcGISJobError;
