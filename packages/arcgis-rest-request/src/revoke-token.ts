...
/**
 * Revokes a token generated via any oAuth 2.0 method. `token` can be either a refresh token OR an access token. If you are using  {@linkcode UserSession} you should use  {@linkcode UserSession.destroy} instead. Cannot revoke API keys or tokens generated by {@linkcode ApplicationSession}.
 *
