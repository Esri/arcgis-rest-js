...
function createMockSession() {
  return new StaticBasemapTilesSession({
    token: "fake-token",
...
async function startMockSession(sessionParams = {}, fetchOptions = {}) {
  ...
  const session = await StaticBasemapTilesSession.start({
    ...{
      styleFamily: "arcgis",
      authentication: "token"
    },
...
describe("StaticBasemapTilesSession", () => {
  test("should create a StaticBasemapTilesSession object from valid parameters", () => {
  ...
  test("should create a StaticBasemapTilesSession object from valid parameters", () => {
    ...
    const session = new StaticBasemapTilesSession({
      token: "fake-token",
      startSessionUrl: DEFAULT_START_STATIC_BASEMAP_SESSION_URL,
      startTime: MOCK_START_TIME,
      endTime: MOCK_END_TIME,
  ...
  test("should start a new StaticBasemapTilesSession", async () => {
    ...
    expect(url).toStartWith(DEFAULT_START_STATIC_BASEMAP_SESSION_URL);
  ...
  test("should start a new StaticBasemapTilesSession with a default style family", async () => {
    fetchMock.getOnce("*", {
      sessionToken: "fake-token",
      startTime: MOCK_START_TIME.getTime(),
      endTime: MOCK_END_TIME.getTime(),
