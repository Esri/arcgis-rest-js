...
export const DEFAULT_SAFETY_MARGIN = 1000 * 60 * 5; // Default to 5 minutes

export const DEFAULT_CHECK_EXPIRATION_INTERVAL = 1000 * 10; // Default to 1 minute

export const DEFAULT_DURATION = 60 * 60 * 12; // Default to 12 hours in seconds
