...
export interface IOAuth2Options {
  ...
  /**
   * Duration (in minutes) that a token will be valid for browser-based OAuth 2.0 or the refresh token will be valid for server-based OAuth 2.0. The default is 2 weeks for both.
   */
  duration?: number;
