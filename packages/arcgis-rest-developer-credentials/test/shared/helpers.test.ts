...
describe("helpers", () => {
  describe("buildExpirationDateParams", () => {
    test("should return an object with expiration date 1 params", () => {
    ...
    test("should return an object with expiration date 2 params", () => {
    ...
    test("should return an object with both expiration date 1 and 2 params", () => {
      const expiration1 = new Date();
      const expiration2 = new Date();
      const expirationDateParams = buildExpirationDateParams({
        apiToken1ExpirationDate: expiration1,
    ...
    test("should fill with a default of -1 when requested", () => {
      const expirationDateParams = buildExpirationDateParams(
        {
  ...
  describe("slotForKey", () => {
    test("should return 1 for a key that contains AT1 in the proper spot", () => {
      expect(
        slotForKey(
    ...
    test("should return 2 for a key that contains AT2 in the proper spot", () => {
      expect(
        slotForKey(
    ...
    test("should return undefined for a non api key string", () => {
      expect(slotForKey("foo")).toEqual(undefined);
    });
  });

  describe("slotForInvalidationKey", () => {
    test("should return 1 for a full key that contains AT1 in the proper spot", () => {
      expect(
        slotForInvalidationKey(
          "AAPTxy6BH1VEsoebNVZXo8HuiIOamKnP-TQacNgPnfkapJPNaUVBDrKX4IISTum7uUKCxustN-33gZ3OIputBuLHf-gu5Bdmw6A4S16pQ5UClfu79W13VBLYaqh3wjRnsCTmO8Q__TiGbXzwote3Z8AcbTMPPQoGqxeV6Z-vr2TQoQHzeLzfJAZzoNrkkTXM9AfYA-dBNrW_eBV9Zl0IYXXNXTR0OQWUZ3PQ5C5OInjh9OU.AT1_G1kye1HB"
        )
    ...
    test("should return 1 or 2 if passed", () => {
