  ...
  template: `
    <div>
      <form v-on:submit.prevent="onSubmit" class="input-group trailer-half leader-0  ">
        <input ref="input" v-on:keyup.enter="onSubmit" v-on:keyup.up="onSelectPrevious" v-on:keyup.down="onSelectNext" v-on:keyup="onChange" class="input-group-input" type="text" placeholder="Search the API Reference">
